...
module OpenGLExt
  ...
  def self.define_ext_enum_GL_EXT_fragment_shading_rate
    ...
    OpenGL.const_set('GL_FRAGMENT_SHADING_RATE_PRIMITIVE_RATE_WITH_MULTI_VIEWPORT_SUPPORTED_EXT', 0x9780) unless defined?(OpenGL::GL_FRAGMENT_SHADING_RATE_PRIMITIVE_RATE_WITH_MULTI_VIEWPORT_SUPPORTED_EXT)
  ...
  def self.define_ext_enum_GL_EXT_mesh_shader
    OpenGL.const_set('GL_MESH_SHADER_EXT', 0x9559) unless defined?(OpenGL::GL_MESH_SHADER_EXT)
    OpenGL.const_set('GL_TASK_SHADER_EXT', 0x955A) unless defined?(OpenGL::GL_TASK_SHADER_EXT)
    OpenGL.const_set('GL_MAX_MESH_UNIFORM_BLOCKS_EXT', 0x8E60) unless defined?(OpenGL::GL_MAX_MESH_UNIFORM_BLOCKS_EXT)
    OpenGL.const_set('GL_MAX_MESH_TEXTURE_IMAGE_UNITS_EXT', 0x8E61) unless defined?(OpenGL::GL_MAX_MESH_TEXTURE_IMAGE_UNITS_EXT)
    OpenGL.const_set('GL_MAX_MESH_IMAGE_UNIFORMS_EXT', 0x8E62) unless defined?(OpenGL::GL_MAX_MESH_IMAGE_UNIFORMS_EXT)
    OpenGL.const_set('GL_MAX_MESH_UNIFORM_COMPONENTS_EXT', 0x8E63) unless defined?(OpenGL::GL_MAX_MESH_UNIFORM_COMPONENTS_EXT)
    OpenGL.const_set('GL_MAX_MESH_ATOMIC_COUNTER_BUFFERS_EXT', 0x8E64) unless defined?(OpenGL::GL_MAX_MESH_ATOMIC_COUNTER_BUFFERS_EXT)
    OpenGL.const_set('GL_MAX_MESH_ATOMIC_COUNTERS_EXT', 0x8E65) unless defined?(OpenGL::GL_MAX_MESH_ATOMIC_COUNTERS_EXT)
    OpenGL.const_set('GL_MAX_MESH_SHADER_STORAGE_BLOCKS_EXT', 0x8E66) unless defined?(OpenGL::GL_MAX_MESH_SHADER_STORAGE_BLOCKS_EXT)
    OpenGL.const_set('GL_MAX_COMBINED_MESH_UNIFORM_COMPONENTS_EXT', 0x8E67) unless defined?(OpenGL::GL_MAX_COMBINED_MESH_UNIFORM_COMPONENTS_EXT)
    OpenGL.const_set('GL_MAX_TASK_UNIFORM_BLOCKS_EXT', 0x8E68) unless defined?(OpenGL::GL_MAX_TASK_UNIFORM_BLOCKS_EXT)
    OpenGL.const_set('GL_MAX_TASK_TEXTURE_IMAGE_UNITS_EXT', 0x8E69) unless defined?(OpenGL::GL_MAX_TASK_TEXTURE_IMAGE_UNITS_EXT)
    OpenGL.const_set('GL_MAX_TASK_IMAGE_UNIFORMS_EXT', 0x8E6A) unless defined?(OpenGL::GL_MAX_TASK_IMAGE_UNIFORMS_EXT)
    OpenGL.const_set('GL_MAX_TASK_UNIFORM_COMPONENTS_EXT', 0x8E6B) unless defined?(OpenGL::GL_MAX_TASK_UNIFORM_COMPONENTS_EXT)
    OpenGL.const_set('GL_MAX_TASK_ATOMIC_COUNTER_BUFFERS_EXT', 0x8E6C) unless defined?(OpenGL::GL_MAX_TASK_ATOMIC_COUNTER_BUFFERS_EXT)
    OpenGL.const_set('GL_MAX_TASK_ATOMIC_COUNTERS_EXT', 0x8E6D) unless defined?(OpenGL::GL_MAX_TASK_ATOMIC_COUNTERS_EXT)
    OpenGL.const_set('GL_MAX_TASK_SHADER_STORAGE_BLOCKS_EXT', 0x8E6E) unless defined?(OpenGL::GL_MAX_TASK_SHADER_STORAGE_BLOCKS_EXT)
    OpenGL.const_set('GL_MAX_COMBINED_TASK_UNIFORM_COMPONENTS_EXT', 0x8E6F) unless defined?(OpenGL::GL_MAX_COMBINED_TASK_UNIFORM_COMPONENTS_EXT)
    OpenGL.const_set('GL_MAX_TASK_WORK_GROUP_TOTAL_COUNT_EXT', 0x9740) unless defined?(OpenGL::GL_MAX_TASK_WORK_GROUP_TOTAL_COUNT_EXT)
    OpenGL.const_set('GL_MAX_MESH_WORK_GROUP_TOTAL_COUNT_EXT', 0x9741) unless defined?(OpenGL::GL_MAX_MESH_WORK_GROUP_TOTAL_COUNT_EXT)
    OpenGL.const_set('GL_MAX_MESH_WORK_GROUP_INVOCATIONS_EXT', 0x9757) unless defined?(OpenGL::GL_MAX_MESH_WORK_GROUP_INVOCATIONS_EXT)
    OpenGL.const_set('GL_MAX_TASK_WORK_GROUP_INVOCATIONS_EXT', 0x9759) unless defined?(OpenGL::GL_MAX_TASK_WORK_GROUP_INVOCATIONS_EXT)
    OpenGL.const_set('GL_MAX_TASK_PAYLOAD_SIZE_EXT', 0x9742) unless defined?(OpenGL::GL_MAX_TASK_PAYLOAD_SIZE_EXT)
    OpenGL.const_set('GL_MAX_TASK_SHARED_MEMORY_SIZE_EXT', 0x9743) unless defined?(OpenGL::GL_MAX_TASK_SHARED_MEMORY_SIZE_EXT)
    OpenGL.const_set('GL_MAX_MESH_SHARED_MEMORY_SIZE_EXT', 0x9744) unless defined?(OpenGL::GL_MAX_MESH_SHARED_MEMORY_SIZE_EXT)
    OpenGL.const_set('GL_MAX_TASK_PAYLOAD_AND_SHARED_MEMORY_SIZE_EXT', 0x9745) unless defined?(OpenGL::GL_MAX_TASK_PAYLOAD_AND_SHARED_MEMORY_SIZE_EXT)
    OpenGL.const_set('GL_MAX_MESH_PAYLOAD_AND_SHARED_MEMORY_SIZE_EXT', 0x9746) unless defined?(OpenGL::GL_MAX_MESH_PAYLOAD_AND_SHARED_MEMORY_SIZE_EXT)
    OpenGL.const_set('GL_MAX_MESH_OUTPUT_MEMORY_SIZE_EXT', 0x9747) unless defined?(OpenGL::GL_MAX_MESH_OUTPUT_MEMORY_SIZE_EXT)
    OpenGL.const_set('GL_MAX_MESH_PAYLOAD_AND_OUTPUT_MEMORY_SIZE_EXT', 0x9748) unless defined?(OpenGL::GL_MAX_MESH_PAYLOAD_AND_OUTPUT_MEMORY_SIZE_EXT)
    OpenGL.const_set('GL_MAX_MESH_OUTPUT_VERTICES_EXT', 0x9538) unless defined?(OpenGL::GL_MAX_MESH_OUTPUT_VERTICES_EXT)
    OpenGL.const_set('GL_MAX_MESH_OUTPUT_PRIMITIVES_EXT', 0x9756) unless defined?(OpenGL::GL_MAX_MESH_OUTPUT_PRIMITIVES_EXT)
    OpenGL.const_set('GL_MAX_MESH_OUTPUT_COMPONENTS_EXT', 0x9749) unless defined?(OpenGL::GL_MAX_MESH_OUTPUT_COMPONENTS_EXT)
    OpenGL.const_set('GL_MAX_MESH_OUTPUT_LAYERS_EXT', 0x974A) unless defined?(OpenGL::GL_MAX_MESH_OUTPUT_LAYERS_EXT)
    OpenGL.const_set('GL_MAX_MESH_MULTIVIEW_VIEW_COUNT_EXT', 0x9557) unless defined?(OpenGL::GL_MAX_MESH_MULTIVIEW_VIEW_COUNT_EXT)
    OpenGL.const_set('GL_MESH_OUTPUT_PER_VERTEX_GRANULARITY_EXT', 0x92DF) unless defined?(OpenGL::GL_MESH_OUTPUT_PER_VERTEX_GRANULARITY_EXT)
    OpenGL.const_set('GL_MESH_OUTPUT_PER_PRIMITIVE_GRANULARITY_EXT', 0x9543) unless defined?(OpenGL::GL_MESH_OUTPUT_PER_PRIMITIVE_GRANULARITY_EXT)
    OpenGL.const_set('GL_MAX_PREFERRED_TASK_WORK_GROUP_INVOCATIONS_EXT', 0x974B) unless defined?(OpenGL::GL_MAX_PREFERRED_TASK_WORK_GROUP_INVOCATIONS_EXT)
    OpenGL.const_set('GL_MAX_PREFERRED_MESH_WORK_GROUP_INVOCATIONS_EXT', 0x974C) unless defined?(OpenGL::GL_MAX_PREFERRED_MESH_WORK_GROUP_INVOCATIONS_EXT)
    OpenGL.const_set('GL_MESH_PREFERS_LOCAL_INVOCATION_VERTEX_OUTPUT_EXT', 0x974D) unless defined?(OpenGL::GL_MESH_PREFERS_LOCAL_INVOCATION_VERTEX_OUTPUT_EXT)
    OpenGL.const_set('GL_MESH_PREFERS_LOCAL_INVOCATION_PRIMITIVE_OUTPUT_EXT', 0x974E) unless defined?(OpenGL::GL_MESH_PREFERS_LOCAL_INVOCATION_PRIMITIVE_OUTPUT_EXT)
    OpenGL.const_set('GL_MESH_PREFERS_COMPACT_VERTEX_OUTPUT_EXT', 0x974F) unless defined?(OpenGL::GL_MESH_PREFERS_COMPACT_VERTEX_OUTPUT_EXT)
    OpenGL.const_set('GL_MESH_PREFERS_COMPACT_PRIMITIVE_OUTPUT_EXT', 0x9750) unless defined?(OpenGL::GL_MESH_PREFERS_COMPACT_PRIMITIVE_OUTPUT_EXT)
    OpenGL.const_set('GL_MAX_TASK_WORK_GROUP_COUNT_EXT', 0x9751) unless defined?(OpenGL::GL_MAX_TASK_WORK_GROUP_COUNT_EXT)
    OpenGL.const_set('GL_MAX_MESH_WORK_GROUP_COUNT_EXT', 0x9752) unless defined?(OpenGL::GL_MAX_MESH_WORK_GROUP_COUNT_EXT)
    OpenGL.const_set('GL_MAX_MESH_WORK_GROUP_SIZE_EXT', 0x9758) unless defined?(OpenGL::GL_MAX_MESH_WORK_GROUP_SIZE_EXT)
    OpenGL.const_set('GL_MAX_TASK_WORK_GROUP_SIZE_EXT', 0x975A) unless defined?(OpenGL::GL_MAX_TASK_WORK_GROUP_SIZE_EXT)
    OpenGL.const_set('GL_MESH_WORK_GROUP_SIZE_EXT', 0x953E) unless defined?(OpenGL::GL_MESH_WORK_GROUP_SIZE_EXT)
    OpenGL.const_set('GL_TASK_WORK_GROUP_SIZE_EXT', 0x953F) unless defined?(OpenGL::GL_TASK_WORK_GROUP_SIZE_EXT)
    OpenGL.const_set('GL_MESH_VERTICES_OUT_EXT', 0x9579) unless defined?(OpenGL::GL_MESH_VERTICES_OUT_EXT)
    OpenGL.const_set('GL_MESH_PRIMITIVES_OUT_EXT', 0x957A) unless defined?(OpenGL::GL_MESH_PRIMITIVES_OUT_EXT)
    OpenGL.const_set('GL_MESH_OUTPUT_TYPE_EXT', 0x957B) unless defined?(OpenGL::GL_MESH_OUTPUT_TYPE_EXT)
    OpenGL.const_set('GL_UNIFORM_BLOCK_REFERENCED_BY_MESH_SHADER_EXT', 0x959C) unless defined?(OpenGL::GL_UNIFORM_BLOCK_REFERENCED_BY_MESH_SHADER_EXT)
    OpenGL.const_set('GL_UNIFORM_BLOCK_REFERENCED_BY_TASK_SHADER_EXT', 0x959D) unless defined?(OpenGL::GL_UNIFORM_BLOCK_REFERENCED_BY_TASK_SHADER_EXT)
    OpenGL.const_set('GL_REFERENCED_BY_MESH_SHADER_EXT', 0x95A0) unless defined?(OpenGL::GL_REFERENCED_BY_MESH_SHADER_EXT)
    OpenGL.const_set('GL_REFERENCED_BY_TASK_SHADER_EXT', 0x95A1) unless defined?(OpenGL::GL_REFERENCED_BY_TASK_SHADER_EXT)
    OpenGL.const_set('GL_TASK_SHADER_INVOCATIONS_EXT', 0x9753) unless defined?(OpenGL::GL_TASK_SHADER_INVOCATIONS_EXT)
    OpenGL.const_set('GL_MESH_SHADER_INVOCATIONS_EXT', 0x9754) unless defined?(OpenGL::GL_MESH_SHADER_INVOCATIONS_EXT)
    OpenGL.const_set('GL_MESH_PRIMITIVES_GENERATED_EXT', 0x9755) unless defined?(OpenGL::GL_MESH_PRIMITIVES_GENERATED_EXT)
    OpenGL.const_set('GL_MESH_SHADER_BIT_EXT', 0x00000040) unless defined?(OpenGL::GL_MESH_SHADER_BIT_EXT)
    OpenGL.const_set('GL_TASK_SHADER_BIT_EXT', 0x00000080) unless defined?(OpenGL::GL_TASK_SHADER_BIT_EXT)
    OpenGL.const_set('GL_MESH_SUBROUTINE_EXT', 0x957C) unless defined?(OpenGL::GL_MESH_SUBROUTINE_EXT)
    OpenGL.const_set('GL_TASK_SUBROUTINE_EXT', 0x957D) unless defined?(OpenGL::GL_TASK_SUBROUTINE_EXT)
    OpenGL.const_set('GL_MESH_SUBROUTINE_UNIFORM_EXT', 0x957E) unless defined?(OpenGL::GL_MESH_SUBROUTINE_UNIFORM_EXT)
    OpenGL.const_set('GL_TASK_SUBROUTINE_UNIFORM_EXT', 0x957F) unless defined?(OpenGL::GL_TASK_SUBROUTINE_UNIFORM_EXT)
    OpenGL.const_set('GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_MESH_SHADER_EXT', 0x959E) unless defined?(OpenGL::GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_MESH_SHADER_EXT)
    OpenGL.const_set('GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TASK_SHADER_EXT', 0x959F) unless defined?(OpenGL::GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TASK_SHADER_EXT)
  ...
  def self.define_ext_enum_GL_HUAWEI_program_binary
    OpenGL.const_set('GL_HUAWEI_PROGRAM_BINARY', 0x9771) unless defined?(OpenGL::GL_HUAWEI_PROGRAM_BINARY)
  ...
  def self.define_ext_enum_GL_HUAWEI_shader_binary
    OpenGL.const_set('GL_HUAWEI_SHADER_BINARY', 0x9770) unless defined?(OpenGL::GL_HUAWEI_SHADER_BINARY)
  ...
  def self.define_ext_enum_GL_MESA_texture_const_bandwidth
    OpenGL.const_set('GL_CONST_BW_TILING_MESA', 0x8BBE) unless defined?(OpenGL::GL_CONST_BW_TILING_MESA)
