...
module GL
  ...
  AUX2 = 0x040B
  AUX3 = 0x040C
  GL_2D = 0x0600 # [NOTE] Renaming was not performed due to grammatical restrictions
  GL_3D = 0x0601 # [NOTE] Renaming was not performed due to grammatical restrictions
  GL_3D_COLOR = 0x0602 # [NOTE] Renaming was not performed due to grammatical restrictions
  GL_3D_COLOR_TEXTURE = 0x0603 # [NOTE] Renaming was not performed due to grammatical restrictions
  GL_4D_COLOR_TEXTURE = 0x0604 # [NOTE] Renaming was not performed due to grammatical restrictions
  ...
  GL_2_BYTES = 0x1407 # [NOTE] Renaming was not performed due to grammatical restrictions
  GL_3_BYTES = 0x1408 # [NOTE] Renaming was not performed due to grammatical restrictions
  GL_4_BYTES = 0x1409 # [NOTE] Renaming was not performed due to grammatical restrictions
  EMISSION = 0x1600
  SHININESS = 0x1601
